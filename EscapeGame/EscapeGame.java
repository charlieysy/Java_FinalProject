...
public class EscapeGame extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		...
		start.setBounds(150, 80, 100, 30);	//左距，上距，寬，長
